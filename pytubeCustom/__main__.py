...
import pytubeCustom
import pytubeCustom.exceptions as exceptions
from pytubeCustom import extract, request
from pytubeCustom import Stream, StreamQuery
from pytubeCustom.helpers import install_proxy
from pytubeCustom.innertube import InnerTube
from pytubeCustom.metadata import YouTubeMetadata
from pytubeCustom.monostate import Monostate
...
class YouTube:
    ...
    def js(self):
        ...
        if pytubeCustom.__js_url__ != self.js_url:
            self._js = request.get(self.js_url)
            pytubeCustom.__js__ = self._js
            pytubeCustom.__js_url__ = self.js_url
        else:
            self._js = pytubeCustom.__js__
    ...
    def fmt_streams(self):
        ...
        try:
            ...
            self._js = None
            self._js_url = None
            pytubeCustom.__js__ = None
            pytubeCustom.__js_url__ = None
            extract.apply_signature(stream_manifest, self.vid_info, self.js)
    ...
    @property
    def caption_tracks(self) -> List[pytubeCustom.Caption]:
        ...
        return [pytubeCustom.Caption(track) for track in raw_tracks]

    @property
    def captions(self) -> pytubeCustom.CaptionQuery:
        """Interface to query caption tracks.

        :rtype: :class:`CaptionQuery <CaptionQuery>`.
        """
        return pytubeCustom.CaptionQuery(self.caption_tracks)
